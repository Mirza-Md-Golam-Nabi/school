    ...
    <div class="rounded-xl bg-white p-3 shadow-sm ring-1 ring-gray-950/5 transition-shadow duration-150 hover:shadow-md dark:bg-gray-900 dark:ring-white/10 sm:p-4">
        <div class="flex items-center gap-x-2 sm:gap-x-4">
            ...
            <div class="min-w-0">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 sm:text-sm">Roll : {{ $roll_no }}</p>
            </div>
        </div>
        ...
        <div class="mt-3 grid grid-cols-2 gap-x-3 gap-y-2 border-t border-gray-200 pt-3 dark:border-white/10 sm:mt-4 sm:pt-3">
            <div class="flex items-center gap-x-1 text-xs sm:text-sm">
                ...
                <span class="truncate text-gray-500 dark:text-gray-400">Class :</span>
            ...
            @if ($hasSection)
                <div class="flex items-center gap-x-1 text-xs sm:text-sm">
                    ...
                    <span class="truncate text-gray-500 dark:text-gray-400">Section :</span>
            ...
            @if ($hasGroup)
                <div class="flex items-center gap-x-1 text-xs sm:text-sm">
                    ...
                    <span class="truncate text-gray-500 dark:text-gray-400">Group :</span>
