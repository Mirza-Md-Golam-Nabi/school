    ...
    <div class="rounded-xl bg-white p-3 shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10 sm:p-4">
        <div class="flex items-center gap-x-2 sm:gap-x-4">
            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary-50 dark:bg-primary-950 sm:h-14 sm:w-14">
                <x-heroicon-o-users class="h-5 w-5 text-primary-600 dark:text-primary-400 sm:h-7 sm:w-7" />
            </div>
            <div class="min-w-0">
                <p class="text-xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-3xl">{{ $totalTeachers }}</p>
                <p class="text-xs text-gray-500 dark:text-gray-400 sm:text-sm">Total Teachers</p>
            </div>
        </div>

        <div class="mt-3 grid grid-cols-2 divide-x divide-gray-200 border-t border-gray-200 pt-2 dark:divide-white/10 dark:border-white/10 sm:mt-4 sm:pt-3">
            ...
            <div class="flex items-center justify-end gap-x-1 pl-2 text-xs sm:text-sm">
