    ...
    >
        <div class="flex items-center gap-x-2 sm:gap-x-4">
            <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary-50 dark:bg-primary-950 sm:h-14 sm:w-14">
                <x-heroicon-o-briefcase class="h-5 w-5 text-primary-600 dark:text-primary-400 sm:h-7 sm:w-7" />
            </div>
            <div class="min-w-0">
                <p class="text-xl font-bold tracking-tight text-gray-900 dark:text-white md:text-3xl">{{ $totalStaff }}</p>
                <p class="text-xs text-gray-500 dark:text-gray-400 sm:text-sm">{{ __('Total Staff') }}</p>
            </div>
        </div>
