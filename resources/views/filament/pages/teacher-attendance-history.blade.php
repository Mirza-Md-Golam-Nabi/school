@assets
<style>
    body:has(.teacher-attendance-history-page) .fi-page-header-main-ctn {
...
<x-filament-panels::page>
    <div class="teacher-attendance-history-page space-y-3">
        ...
        <div class="rounded-xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10">
            ...
            <div class="flex items-center gap-x-2 border-b border-gray-100 px-3 py-2.5 dark:border-gray-800">
                <a href="{{ route('filament.admin.pages.teacher-attendance') }}">
        ...
        @else
            <div class="grid grid-cols-2 gap-2.5 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6">
                @foreach ($history as $record)
                    <a
                        href="{{ route('filament.admin.pages.teacher-attendance') }}?date={{ \Carbon\Carbon::parse($record->date)->toDateString() }}"
                    ...
                    >
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-x-1">
                                    <div class="h-1.5 w-1.5 rounded-full bg-danger-500"></div>
