@php
    ...
    // has, so the sheet stays balanced whether it's 4 subjects or 12.
    $reservedColumnsPercent = 6 + ($hasSections ? 8 + 8 : 0) + 8 + 7 + 7 + 7 + 14;
    $subjectColumnWidth = max((100 - $reservedColumnsPercent) / max($subjects->count(), 1), 5);
@endphp
<!DOCTYPE html>
<html>
