...
class StudentFeeInvoiceUpdatedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    private function buildBody(): string
    {
        ...
        return "Your {$feeType} invoice ({$period}) has been updated — Net payable: {$amount}.";
    }
}
