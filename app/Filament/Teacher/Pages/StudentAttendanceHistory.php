...
{
    protected string $view = 'filament.teacher.pages.student-attendance-history';
    ...
    public function getBreadcrumbs(): array
    {
        return [
            ...
            route('filament.teacher.pages.mark-student-attendance').'?classId='.$this->classId => $this->resolveClass()?->name ?? 'Class',
            '' => 'History',
        ];
    }
