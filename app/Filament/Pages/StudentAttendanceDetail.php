...
class StudentAttendanceDetail extends Page
{
    ...
    protected string $view = 'filament.pages.student-attendance-detail';
    ...
    public function getBreadcrumbs(): array
    {
        ...
        return [
            ...
            ($classId ? route('filament.admin.pages.mark-student-attendance').'?classId='.$classId : '#') => $student?->class?->name ?? 'Class',
            '' => 'History',
        ];
    }
